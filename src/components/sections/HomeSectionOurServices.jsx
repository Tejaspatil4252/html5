  ...
  const services = [
    {
      ...
      description: "The development of reliable and scalable software solutions for any OS, browser and device. We bring together deep industry expertise and the latest IT advancements to deliver custom solutions and products that perfectly fit the needs and behaviour of their users.",
    ...
    <section className="bg-white py-20">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            Rapportsoft Suite of Products are built on J2EE platform. Rapportsoft services for the products built on advanced technologies include the following -
          </motion.p>
